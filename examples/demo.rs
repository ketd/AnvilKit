...
//!
//! Interactive version of the PBR showcase:
//! - WASD/Arrows to orbit camera, Q/E up/down, +/- zoom, ESC quit
//! - 3 DamagedHelmet instances, 4 animated lights
//! - Full PBR pipeline with all texture maps
...
impl ApplicationHandler for ShowcaseApp {
    ...
    fn about_to_wait(&mut self, _el: &ActiveEventLoop) {
        ...
        let eye = glam::Vec3::new(
            ...
            self.orbit_pitch.sin() * self.orbit_distance,
            self.orbit_yaw.cos() * self.orbit_pitch.cos() * self.orbit_distance,
        );
