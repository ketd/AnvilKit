...
///
/// ```rust
/// use anvilkit_ecs::state::GameState;
///
/// #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Default)]
...
///
/// ```rust
/// use anvilkit_ecs::state::NextGameState;
///
/// #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Default)]
/// enum MyState { #[default] Menu, Playing }
///
...
///
/// ```rust
/// use anvilkit_ecs::state::{GameState, in_state};
///
/// #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Default)]
/// enum MyState { #[default] Menu, Playing }
///
...
mod tests {
    ...
    fn test_state_transition_system() {
        ...
        // Request transition
        app.world.resource_mut::<NextGameState<TestState>>().set(TestState::Playing);
        app.update();
