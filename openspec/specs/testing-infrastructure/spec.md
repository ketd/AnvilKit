...
## Purpose
Testing standards and infrastructure for AnvilKit, ensuring comprehensive coverage across all crates.

**Status**: Active | **Current coverage**: 352 tests (135 unit + 217 doc tests) across 3 crates
## Requirements
